...
%a column of X is a vector of one discriptor, the number of rows of X is
%total discriptors of one image 
...
while t < pars.num_trials
    ...
    stat.total_training_time=stat.total_training_time+stat.elapsed_time(t);
